...
class Command:
    ...
    def add_commands():
        ...
        Command.commands[ 'thermostat-damping' ]     = Command.Value( 0.1, Command.TYPE_FLOAT, Command.RANGE_POS, 1, units="/ps" )
        Command.commands[ 'thermostat-temperature' ] = Command.Value( 300., Command.TYPE_FLOAT, Command.RANGE_0POS, 1, units="K" )
...
#		Command.commands[ 'barostat-damping' ]  = Command.Value( 0.1, Command.TYPE_FLOAT, Command.RANGE_POS, 1 )
        Command.commands[ 'barostat-pressure' ] = Command.Value( 1.01325, Command.TYPE_FLOAT, Command.RANGE_0POS, 1, units="bar" )
        Command.commands[ 'barostat-mode' ]     = Command.List( "iso", [ "iso", "aniso", "membrane" ] )
        Command.commands[ 'barostat-surface-tension' ]     = Command.Value( 0, Command.TYPE_FLOAT, Command.RANGE_0POS, 1, units="bar.nanometre" )
...
#		Command.commands[ 'restartfreq' ]    = Command.Value( 25000, Command.TYPE_INT , Command.RANGE_0POS, 1 )
        ...
        Command.commands[ 'celldimension' ]  = Command.Value( None, Command.TYPE_FLOAT, Command.RANGE_POS, 3, units="angstrom" )
        ...
        Command.commands[ 'constraints-strength' ] = Command.Value( 1.0, Command.TYPE_FLOAT, Command.RANGE_0POS, 1, units="kcal/mol/angstrom**2" )
        Command.commands[ 'constraints-selection' ] = Command.String( "beta > 0", "Atom selection" )
        Command.commands[ 'constraints-decay' ] = Command.Value( 0, Command.TYPE_FLOAT, Command.RANGE_0POS, 1, units="kcal/mol/ps" )
        Command.commands[ 'flatbottom' ] = Command.Binary( False )
        Command.commands[ 'flatbottom-file' ] = Command.File( None, exist=True )
        Command.commands[ 'flatbottom-strength' ] = Command.Value( 1.0, Command.TYPE_FLOAT, Command.RANGE_0POS, 1, units="kcal/mol/angstrom**2" )
        ...
        Command.commands[ 'flatbottom-range' ] = Command.Value( [20,20,20], Command.TYPE_FLOAT, Command.RANGE_0POS, 3, units="angstrom" )
        Command.commands[ 'flatbottom-offset' ] = Command.Value( [0, 0, 0], Command.TYPE_FLOAT, Command.RANGE_ANY, 3, units="angstrom" )
        Command.commands[ 'flatbottom-decay' ] = Command.Value( 0, Command.TYPE_FLOAT, Command.RANGE_0POS, 1, units="kcal/mol/ps" )
